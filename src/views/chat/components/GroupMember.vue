...
export default {
  ...
  methods: {
    ...
    addFriends() {
      ...
      this.$socket.emit('add_contact_by_group', { tjId: this.tjId, groupId: this.groupId, memberId: this.groupMemberId, message: this.message, lost: this.curMebInfo.lost }, ack => {
